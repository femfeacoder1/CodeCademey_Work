# -*- coding: utf-8 -*-
"""
Created on Sat Jan 13 15:56:16 2024
...
for item in thread_sold:
  ...
  if item.find('&') <0:
   thread_sold_split.append(item) 
    ...
    temp = item.split('&')
    for subitem in temp:
      thread_sold_split.append(subitem)
...
for item in colors:
  ...
  print("There were {} of the {} thread sold today.".format(count, item))
